    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where(function ($query) {
                ...
                if (auth()->user()->hasRole('Super Admin') || auth()->user()->hasRole('Admin Unit')) {
                    return;
                }

                if (auth()->user()->hasRole('Staff Unit') || auth()->user()->hasRole('Cyber Unit') || auth()->user()->hasRole('General Unit')) {
